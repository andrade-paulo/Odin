...
\begin{document}	
	...
	\input{textuais/embasamento-teorico}
  	\input{textuais/trabalhos-relacionados}
	\input{textuais/arquitetura-distribuida}
	\input{textuais/sistema-embarcado}
	\input{textuais/middleware}
	\input{textuais/on-site-client}
