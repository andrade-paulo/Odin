...
\begin{document}	
	...
	\input{textuais/2-fundamentacao-teorica}
  \input{textuais/3-trabalhos-relacionados}
	\input{textuais/4-metodologia}
	\input{textuais/5-resultados}
	\input{textuais/6-conclusao}
